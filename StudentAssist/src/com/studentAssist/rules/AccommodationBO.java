...
public class AccommodationBO
{
  ...
  public String createUser(String firstName, String lastName, String phoneNumber, String email, String gcmId, String userId)
  {
  ...
  public String createAccommodationAdd(String userId, String apartmentName, String noOfRooms, String vacancies, String cost, String gender, String fbId, String notes)
  {
    Session session = this.sessionFactory.openSession();
  ...
  public List<RAccommodationNotification> getNotificationSettings(String userId)
  {
    ...
    String spinner1 = "";String spinner2 = "";
